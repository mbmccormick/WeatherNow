    ...
    public partial class App : Application
    {
        ...
        private void PromptForMarketplaceReview()
        {
            ...
            if (DateTime.UtcNow.AddDays(-3) >= installDate) // prompt after 3 days
            {
                ...
                {
                    Caption = "Review Weatherman",
                    Message = "It's been a few days since you downloaded Weatherman. Would you like to write a review for it in the Windows Phone Store?",
